...
- On desktop, the Premium featured story has a 3:2 image with copy below on a dark Premium-burgundy surface connected by a gradient. Five non-hero stories use horizontal compact image-left/text-right cards; thumbnails are 3:2 and at least 40% of card width. The Premium CTA has a 3px radius. Mobile and tablet show the featured story and two compact stories.
