...
- At desktop widths, CSS grid stretches all three rails to the first-column height. The middle rail uses vertical flex distribution for its visible stories/ad; the Premium rail fills the height with its CTA at the bottom. Content can grow the grid rather than being clipped.
