...
- The Premium featured story has a 3:2 image with copy below on a dark Premium-burgundy surface connected by a gradient on desktop and mobile. Each Premium headline starts with the supplied `premium-icon.png` Nandi badge, sized to one text line; wrapped lines return to the heading edge below the badge. Desktop shows five non-hero stories as horizontal compact image-left/text-right cards; thumbnails are 3:2 and at least 40% of card width. The Premium CTA has a 3px radius. Mobile and tablet show two compact stories in their responsive layout; the mobile Premium panel has a 4px radius.
